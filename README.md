Raindrop is an app/webapp that provides easy access to a variety of sources for weather information, all from a single interface. The current version supports easy access to radar data from weather.gov.
